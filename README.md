...
The same e-commerce journey (**browse → add-to-cart → checkout**), implemented across six tools (five backend load-testing tools plus a frontend Core Web Vitals one) — each a **one-command Dockerized demo** that spins up a mock backend,
